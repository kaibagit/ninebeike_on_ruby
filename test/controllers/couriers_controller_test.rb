...
class CouriersControllerTest < ActionController::TestCase
  ...
  test "should create courier" do
    assert_difference('Courier.count') do
      post :create, courier: { hashed_password: @courier.hashed_password, name: @courier.name, salt: @courier.salt, username: @courier.username }
    end
  ...
  test "should update courier" do
    patch :update, id: @courier, courier: { hashed_password: @courier.hashed_password, name: @courier.name, salt: @courier.salt, username: @courier.username }
    assert_redirected_to courier_path(assigns(:courier))
  end
